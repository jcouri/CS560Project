...
public class BestPath {
	...
	public void readIn() {
		try {
			BufferedReader in = new BufferedReader(new FileReader("./src/groupProgramAssignment/input.txt"));
			String line;
			int j;
			for(int i = 1; i <= 233; i++) {
				line = in.readLine();
	...
	public void pprint(){
		try {
			PrintWriter out = new PrintWriter("./src/groupProgramAssignment/output.txt");
			int i;
			while(top > 0) {
				i = pop().index;
				out.println(i);
